...
['Bid resources not available',
    ...
    // browser.execute(function(){window.open('https://svt4sugarlb01a.rtp.raleigh.ibm.com/sales/salesconnect/','_blank')});
    var fs = require('fs');
    browser
      ...
      //.waitForElementVisible("#header > div > div > div > div.module-list > ul > li:nth-child(11) > span > a",40*time_out)
     // util.svt4(browser,"SOC-O904X9X");
      for(var i=0;i<3;i++){
